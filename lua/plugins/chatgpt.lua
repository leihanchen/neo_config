local conf = {
  ...
  openai_api_key = "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",
  ...
  chat_model = { model = "gpt-3.5-turbo-16k", temperature = 0.8, top_p = 1 },
  ...
  command_model = { model = "gpt-3.5-turbo-16k", temperature = 0.8, top_p = 1 },
